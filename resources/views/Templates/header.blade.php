...
<head>
  ...
  <!-- summernote -->
  <link rel="stylesheet" href="{{ asset('asset/adminlte/plugins/summernote/summernote-bs4.css') }}">
  ...
  <!-- Ionicons -->
  <link rel="stylesheet" href="https://code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css">  <!-- DataTables -->
