            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <thead>
                  ...
                  @foreach($menu as $p)
                  <tr>
                    <td style="width:15%;">{{$p->id_menu}}</td>
                    <td style="width:20%;">{{$p->nama_menu}}</td>
                    <td style="width:25%;">{{$p->deskripsi}}</td>
                    <td style="width:20%;">{{$p->harga_menu}}</td>
                    <td style="width:20%; text-align:center;">
                        <a class="btn btn-warning"href="{{ url('/Admin/Menu/Ubah/'.$p->id_menu)}}"><i value="Edit">Ubah</a>
                        <a value='delete'>
